...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/unknowncoin.conf are parsed in qt/bitcoin.cpp's main()
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: unknowncoin.conf)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 12666 or testnet: 32666)") + "\n" +
